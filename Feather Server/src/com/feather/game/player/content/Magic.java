...
public class Magic {
	...
	private final static WorldTile[] ALTARTABS = {new WorldTile(3107, 3160, 1),
			new WorldTile(3125, 3406, 0), new WorldTile(2980, 3513, 0),
			new WorldTile(3183, 3165, 0), new WorldTile(3304, 3474, 0),
			new WorldTile(3313, 3253, 0), new WorldTile(3052, 3443, 0),
			new WorldTile(2410, 4377, 0), new WorldTile(3063, 3589, 0),
			new WorldTile(2869, 3017, 0), new WorldTile(2857, 3379, 0),
			new WorldTile(1863, 4639, 0), new WorldTile(3561, 9779, 0),
			new WorldTile(2156, 3864, 0)};

	private final static WorldTile[] TABS = { new WorldTile(3217, 3426, 0),
			new WorldTile(3222, 3222, 0), new WorldTile(2965, 3379, 0),
			new WorldTile(2758, 3478, 0), new WorldTile(2660, 3306, 0),
			new WorldTile(2551, 3114, 0)};
	...
	public static boolean useAltarTeleport(final Player player, final int itemId) {
		if (itemId < 13598 || itemId > 13598 + ALTARTABS.length - 1)
			return false;
		if (useTeleTab(player, ALTARTABS[itemId - 13598]))
			player.getInventory().deleteItem(itemId, 1);
			return true;
	}
