...
//		}
	...
	private void addOre(Player player) {
		...
		} else if (definitions == RockDefinitions.Granite_Ore) {
			player.getInventory().addItem(6979, 1);
			player.getSkills().addXp(Skills.MINING, 50);
		} else if (definitions == RockDefinitions.Gold_Ore) {
			player.getInventory().addItem(444, 1);
			player.getSkills().addXp(Skills.MINING, 60);
		} else if (definitions == RockDefinitions.Mithril_Ore) {
			player.getInventory().addItem(447, 1);
			player.getSkills().addXp(Skills.MINING, 80);
		} else if (definitions == RockDefinitions.Adamant_Ore) {
			player.getInventory().addItem(449, 1);
			player.getSkills().addXp(Skills.MINING, 95);
		} else if (definitions == RockDefinitions.Runite_Ore) {
			player.getInventory().addItem(451, 1);
			player.getSkills().addXp(Skills.MINING, 125);
...
//		}
			...
			int[] gems = {1617, 1619, 1621, 1623, 1625, 1627, 1629, 1631};
