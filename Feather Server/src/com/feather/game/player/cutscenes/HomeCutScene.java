...
import com.feather.game.player.cutscenes.actions.ConstructMapAction;
import com.feather.game.player.cutscenes.actions.CreateNPCAction;
import com.feather.game.player.cutscenes.actions.CutsceneAction;
import com.feather.game.player.cutscenes.actions.DestroyCachedObjectAction;
import com.feather.game.player.cutscenes.actions.LookCameraAction;
import com.feather.game.player.cutscenes.actions.MoveNPCAction;
import com.feather.game.player.cutscenes.actions.MovePlayerAction;
import com.feather.game.player.cutscenes.actions.NPCAnimationAction;
import com.feather.game.player.cutscenes.actions.NPCFaceTileAction;
import com.feather.game.player.cutscenes.actions.NPCForceTalkAction;
import com.feather.game.player.cutscenes.actions.NPCGraphicAction;
import com.feather.game.player.cutscenes.actions.PlayerAnimationAction;
import com.feather.game.player.cutscenes.actions.PlayerFaceTileAction;
import com.feather.game.player.cutscenes.actions.PlayerForceTalkAction;
import com.feather.game.player.cutscenes.actions.PlayerGraphicAction;
import com.feather.game.player.cutscenes.actions.PlayerMusicEffectAction;
