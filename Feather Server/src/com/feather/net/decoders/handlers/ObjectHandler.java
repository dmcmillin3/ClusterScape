...
//						break;
	...
	private static void handleOptionExamine(final Player player, final WorldObject object) {
		...
		//Add examine to Mod/Specific player
		if(player.getRights() == 2) {
			player.getPackets().sendGameMessage("Object ID: " + object.getId() + " Type: " +
		object.getType() + " Coords X, Y, Z: " + object.getX() + ", " + object.getY() + ", " +
		object.getPlane() + ". " + "Rotation: " + object.getRotation());
		}
		player.getPackets().sendGameMessage(
